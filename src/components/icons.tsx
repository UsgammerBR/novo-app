...
export const CustomMenuIcon = ({ className, isChristmas }: { className?: string; isChristmas?: boolean }) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    {isChristmas ? (
        <path d="M12 2L4 18h16L12 2z" fill="#166534" stroke="#14532d" />
    ) : (
        <>
...
export const IconRemote = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const IconCameraLens = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
export const IconCloud = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M17.5 19c2.5 0 4.5-2 4.5-4.5 0-2.3-1.7-4.2-4-4.5a7 7 0 1 0-13.5 3c-2.3.3-4 2.2-4 4.5C0.5 17 2.5 19 5 19h12.5z" />
  </svg>
);
...
export const LoadingBoxIcon = () => (
    <div className="relative w-16 h-16">
        ...
        <div className="absolute inset-0 border-4 border-blue-500 rounded-2xl animate-[spin_3s_linear_infinite] border-t-transparent"></div>
